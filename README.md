...
Code isn't "clever" if no-one understands it. Clever code anticipates the questions and doubts its maintainers will have. It is straightforward and easy to comprehend, to others and your future self. It should be written firstly for people, and then for machines.
